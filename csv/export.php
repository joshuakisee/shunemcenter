...
<div class="wrapper">
    ...
    <aside class="main-sidebar" style="background-color: #d2d3cb;">
            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="dashboad"><i class="fa fa-circle-o"></i>Confrence Halls</a></li>
                        <li><a href="Dinning"><i class="fa fa-circle-o"></i>Dinning && Catering</a></li>
                        <li><a href="recrational"><i class="fa fa-circle-o"></i>Recriational Activities</a></li>
                        <li><a href="csv\export.php"><i class="fa fa-circle-o"></i>My Report</a></li>
                    </ul>
                </li>
            </ul>
...
<!-- <select name="select">
	...
	<option value="DinningCatering">Dinning/Catering</option>
