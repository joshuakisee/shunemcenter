        ...
        <div class="demo-card-wide mdl-card mdl-shadow--4dp  mdl-cell mdl-cell--12-col mdl-cell--12-col-tablet">
            ...
            <form method="POST" enctype="multipart/form-data" class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="hall_name" required  placeholder="Kenya hall">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="capacity" required  placeholder="70 people">
                        </div>
                    </div>
                </div>                
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="Light">Light System</label>
                            <select name="Light" class="form-control" required>
                                <option value="Yes">Yes</option>
                                <option value="No">No</option>
                            </select>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="fee">Hall Cost</label>
                            <input type="number" name="fee" required placeholder="7000">
                        </div>
                    </div>
                </div>
