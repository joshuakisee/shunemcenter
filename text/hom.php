...
<div class="DesignHolder">
	...
	<div class="LayoutFrame">
        ...
        <header>
            <div class="Center">
                <div class="site-logo">
                	<h1><a href="#">farm<span>guide</span>info</a></h1>
                </div>
               <div id="mobile_sec">
        ...
        <div id="Container">
            ...
            <div class="About_sec" id="about">
                <div class="Center">            	
                    <h2>about us</h2>            		
                    <p>Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit<br> amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio.</p>
                    <div class="Line"></div>	
                    <!-- \\ Begin Tab side \\ -->
                    <div class="Tabside">
                        <ul>
                ...
                <div class="Get_sec">
                    <div class="Mid">					
                        ...
                        <div class="Leftside">
                            <form action="#">
                                <fieldset>
                                    <p><input type="text" value=""  name="hey" placeholder="NAME" class="field"></p>
