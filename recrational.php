        ...
        <div class="demo-card-wide mdl-card mdl-shadow--4dp  mdl-cell mdl-cell--12-col mdl-cell--12-col-tablet">
            ...
            <form method="POST" enctype="multipart/form-data" class="box-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="Event" required  placeholder="Bike Ridding">
                        </div>
                    </div>
                </div>                
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="fee">Event Cost</label>
                ...
                <p>
                    <input class="btn btn-primary" type="submit" name="submiting" value="Send Details">
                </p>
            ...
            <?php
            include('uploadRecreational.php');
            ?>
        </div>
    </div>
</main>
